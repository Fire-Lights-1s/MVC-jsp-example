...
<head>
<meta charset="UTF-8">
<title>member2/main.jsp</title>
<link rel="stylesheet" href="../css/table.css?after">
</head>
<body>
	<h1>member2/main.jsp</h1>
	<table>
	...
	<%if(session.getAttribute("id") != null &&session.getAttribute("id").equals("admin")){ %>
		...
		<tr>
			<td><a href="../board2/write.jsp" class="button btnLightBlue">글쓰기</a></td>
			<td><a href="../board2/list.jsp" class="button btnLightBlue">글목록 보기</a></td>
		</tr>
		<tr>
