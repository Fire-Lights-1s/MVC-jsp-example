 ...
 * Generated at: 2024-07-04 08:36:01 UTC
...
public final class deletePro_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>member/deletePro.jsp</title>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
	...
	try {
		MemberDTO memberDB =memberDAO.getMember(conn, memberRequest.getId());
		if (memberDB != null) {
			idDB = memberDB.getId();
			passDB = memberDB.getPass();
			if (memberDAO.userCheck(conn, memberRequest)) {
				check = true;
			} else {
				check = false;
	...
	if (check) {
		memberDAO.deleteMember(conn, memberRequest);
		session.invalidate();
